...
#-----------------------------------------------------------------------------        
        ...
        methodOptionMenu.grid(column=0, row=3, pady=(0,80))
#-----------------------------------------------------------------------------
        
        label1=tk.Label(self, text="Gauss_sigma:")
        label1.grid(column=0, row=4, pady=(0,2))
        ...
        Seg_para_slider1.grid(column=0, row=5, pady=(0,20))

        Seg_para_slider1.set(gauss_sigma0)
        
        label2=tk.Label(self, text="Feature separation:")
        label2.grid(column=0, row=6, pady=(0,2))
        ...
        Seg_para_slider2.grid(column=0, row=7, pady=(0,20))
...
#----------------------------------------------------------------------------- 
        ...
        load_first_btn.grid(column=0, row=11, padx=15, pady=(20,0))
